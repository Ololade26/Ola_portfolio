    ...
    options.forEach(option => {
        ...
        if (option.url) {
            ...
            html += `
                ...
                <button onclick="navigator.clipboard.writeText('${option.command}')" style="padding: 0.5rem 1rem; background: #2ecc71; color: white; border: none; border-radius: 5px; margin-top: 0.5rem; cursor: pointer;">Copy Command</button>
            `;
        }
